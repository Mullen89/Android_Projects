...
//
/**
 * This class allows for the app to automatically perform a function.
 * It used to automatically update the diet history page every day
 * at 11:59pm.
 *
 * Removed due to issues after a reboot/while phone was shut off.
 */
